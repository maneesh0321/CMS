...
<body>
	...
	<div style="background-color: #f2f2f2;">
		<table>
			...
			<tr><td><br></td></tr>
			<tr>
				<td colspan="2"><input style="font-size: 28px; background-color: #228B22; border: 1px solid #228B22; box-shadow: 2px 2px #a6a6a6; color: white; border-radius: 10px;" type="submit" value="Recover Password"></td>
			</tr>
			</form>
		</table>
	</body>
